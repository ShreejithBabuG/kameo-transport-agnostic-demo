...
### WebSocket CORS
For cross-origin browser access, configure CORS in `ping-http-server`.

## Known Limitations

- WebSocket server currently binds to localhost only
- CLI DHT lookup requires ~15 second wait time
- No authentication/authorization implemented
- Single actor instance per server (no horizontal scaling)

## Dependencies

### Core
- **Kameo 0.19**: Actor framework with remote messaging
- **libp2p 0.56**: P2P networking for CLI components
...
This is a research/demonstration project. Refer to component licenses:
- Kameo: MIT/Apache-2.0
- libp2p: MIT
- Axum: MIT

## Acknowledgments

Developed as part of distributed systems research at Carnegie Mellon University, demonstrating transport-agnostic actor architectures using the Kameo framework.

## Future Work

- Add authentication layer
- Implement actor pooling for load distribution
- Add metrics and monitoring
- Support additional transports (gRPC, HTTP/2)
